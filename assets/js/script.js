...
function ready(argument){
    ...
    //    old = parent.querySelector('.product-tab-btn.active');
    //    old.classList.remove('active');
    //    el.classList.add('active');
    //    document.querySelector('#' + old.getAttribute('data-tab-id')).classList.add('hide');
    //    document.querySelector('#' + el.getAttribute('data-tab-id')).classList.remove('hide');
    //}
